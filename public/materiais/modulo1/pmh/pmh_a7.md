...
Na prova, lembre que a **beta-oxidação** de cadeias longas depende de **ativação citoplasmática** e do sistema da **carnitina** para entrada mitocondrial. O ponto regulatório mais cobrado é o **malonil-CoA**, que inibe a **CPT I** e impede que a célula oxide gordura enquanto está em estado de síntese lipídica.

Também é clássico diferenciar o destino de cadeias pares e ímpares: as ímpares terminam em **propionil-CoA**, que pode seguir para **succinil-CoA**. Em termos hormonais, a lógica é recíproca: **insulina** favorece armazenamento e lipogênese, enquanto o **jejum** favorece mobilização e oxidação.
