...
- **Albumina** não é marcador nutricional **puro** no **grave**.
- **Fase aguda** altera **ferro**, **albumina**, **pré-albumina**.
- **PKU** = fenilalanina; **restrição** precoce.
- **Homocist(e)ina** — metabolismo de **metionina** e **cofatores**.
