...
**Figura-ID:** `BMF1-A21-F01`

- **Momento:** após porta hepática.
- **O que mostrar:** vista inferior do fígado com vesícula, ducto hepático comum, colédoco e veia porta.
- **Tipo sugerido:** ilustração estilo Netter/Moore.
- **Legenda (rascunho):** “Hepatobiliar: porta hepática e trajeto do colédoco.”
- **Notas (opcional):** Commons “extrahepatic bile ducts anatomy”.
...
## Pâncreas: cabeça, corpo e cauda

A **cabeça** encaixa no **duodeno**; o **ducto pancreático principal** (**Wirsung**) corre até a **papila** maior, muitas vezes com **colédoco** — **ampola** de Vater. **Papila** menor acessória pode existir. **Cauda** chega ao **baço** — relação importante em **imagem** axial.

---

## Relação vascular rápida

A **artéria hepática** (ramo da **celíaca**) e a **veia porta** entram na **porta**; a **veia hepática** **drena** para a **cava** **inferior** pelas **veias** hepáticas **supra-hepáticas** — **caminho** do sangue **portal** versus **sistêmico** de saída.

---

## Linfonodos e hilo (menção)

O **hilo** hepático concentra **estruturas** e **linfonodos** de **drenagem** portal; o **pâncreas** drena para **cadeias** que seguem **artéria** e **veia** esplênica e **tronco** celíaco. Novamente, **detalhe** cirúrgico fica para estágios clínicos — aqui só a **lógica** de **seguir** os **vasos**.

---

## Ponte com a Clínica

**Cólico biliar** — dor em **hipocôndrio** direito pós-prandial; **pancreatite biliar** — cálculo **impactado** na **ampola**. **Icterícia** **pre-hepática** versus **obstrutiva** — **bilirrubinas** e **imagem** discriminam; a **anatomia** do **colédoco** orienta **CPRE** e **cirurgia**.
...
Trajeto da bile do fígado ao duodeno em cinco estruturas nomeadas (parcialmente variável). Onde está a vesícula em relação ao lobo hepático.

Uma frase sobre papila maior e colédoco/Wirsung. Por que obstrução distal do colédoco pode dilatar intra-hepático (conceito).
