...
def nuke_broken_bmf():
    print("Iniciando NUCLEAR BMF PURGE v13...")
    
    # Target character: U+FFFD (Replacement Character)
    target_char = '\ufffd'
    ...
    def process_file(filename):
        ...
        for q in data['questoes']:
            # Check for the replacement character in any field
            if target_char in str(q):
                purged_count += 1
                continue
