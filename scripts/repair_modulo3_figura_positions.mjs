/**
 * Reinsere o bloco ### Figura sugerida após relevância (lógica bridge + H2).
 * Só pastas canónicas do Módulo 3.
 */
import fs from "fs";
...
const outPath = path.resolve("data/repair_modulo3_figura_report.json");
