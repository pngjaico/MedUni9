...
function cleanLine(text, slideTitle) {
  ...
  // Decouple stuck words first
  t = t.replace(/CARTILAGEMFIBROSA/ig, 'Cartilagem fibrosa');
  t = t.replace(/TECIDOADIPOSO/ig, 'Tecido adiposo');
  t = t.replace(/TECIDOCONJUNTIVO/ig, 'Tecido conjuntivo');
...
console.log(`Sucesso SUPER-FINAL!`);
