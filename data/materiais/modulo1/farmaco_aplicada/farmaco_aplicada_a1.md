...
- **Momento:** Seção de transporte de membrana.
- **O que mostrar:** O **Esquema de Difusão**: Bicamada lipídica com moléculas atravessando via difusão passiva, facilitada e ativa (ATP).
...
1. **Fase I (Não Sintética)**: Reações de oxidação, redução e hidrólise. O sistema de enzimas **Citocromo P450 (CYP450)** é o protagonista aqui.
2. **Fase II (Sintética)**: Reações de **conjugação** (glicuronidação, sulfatação). Resultam em metabólitos inativos e altamente polares.
...
| **Fase I Metabolism**| Funcionalização (Oxidação) | **CYP450** |
| **Fase II Metabolism**| Conjugação (Solubilização) | **Hidrossolubilidade** |

### Frase-âncora para não esquecer
> **"Ácido no Ácido, Base na Base: é assim que a absorção faz a sua fase. Se o Vd é alto, o fármaco está no tecido; se a meia-vida passou 5 vezes, o Steady State foi atingido."**
