...
## CHC — fatores e apresentação

Vírus B/C, álcool, **NASH** em ascensão. Pode ser assintomático (nódulo em USG) ou com descompensação hepática. **AFP** elevada é útil mas **não** obrigatória para diagnóstico.

### Diagnóstico por imagem

**RM** ou **TC multiphase** com padrão característico em cirrótico pode evitar biópsia em cenários específicos (protocolos). Nódulos **>1 cm** exigem algoritmo rigoroso.
...
Cirrótico com **nódulo novo** e **AFP normal** — ainda assim investigue (imagem). Paciente ictérico febril: **não** atrasar antibiótico nem desobstrução por “completar estadiamento” primeiro.
...
- CHC: cirrose subjacente na maioria; rastreio USG+AFP.
- Milão / BCLC: conceitos de tratamento curativo vs paliativo.
- Colangiocarcinoma: icterícia obstrutiva; MRCP/TC; CPRE para drenar.
- Colangite: ABC + antibiótico + desobstrução.
...
|------------|------------|------------------|
| CHC | metástase | Imagem, marcadores, primário |
| Klatskin | coledocolitíase | TC/MRCP, evolução |
| Colangite | hepatite | Coluria, dilatação ductal, desobstrução |
