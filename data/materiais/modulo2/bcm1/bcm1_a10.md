...
- **Momento:** Seção de motor do ciclo (Ciclinas/CDKs).
- **O que mostrar:** O "Painel de Controle": Um círculo representando o ciclo celular (G1, S, G2, M). Em cada etapa, uma chave (Ciclina) entra numa fechadura (CDK) para abrir o portão. Mostrar o **p53** e a **Rb** como cadeados extras que impedem a abertura se houver perigo.
- **Tipo sugerido:** Infográfico didático.
- **Legenda (rascunho):** O complexo sistema de controle que garante a divisão celular segura.

## 1. As Fases do Ciclo

- **G1 (Crescimento):** A célula decide se vai se dividir ou não.
...
A **Síndrome de Li-Fraumeni** é uma condição genética rara onde o paciente nasce com apenas uma cópia funcional do gene da **p53**. Isso significa que ele tem uma chance enorme (quase 100%) de desenvolver vários tipos de câncer ao longo da vida (mama, sarcomas, tumores cerebrais), pois suas células perdem facilmente o "fiscal" que monitora os danos no DNA. Esses pacientes precisam de um acompanhamento médico intensivo desde a infância.

---

## Pontos-Chave para Prova

- **Fase S**: Onde ocorre a **Duplicação** do DNA.
- **Fase M**: Divisão celular (Mitose).
- **Rb**: O freio que bloqueia o **E2F**.
- **p53**: O supressor de tumor mutado em **50% dos cânceres**.
- **p21**: O braço direito da p53 (Inibe as CDKs).
- **Ciclina D**: A chave que inicia o ciclo em G1.
...
Para gabaritar Ciclo Celular, foque no controle de G1 para S. 
Lembre-se: para a célula pular de G1 para S, a **Rb** precisa ser "desligada" (fosforilada) pela **CDK4/6**. Se houver dano no DNA, o **p53** entra em cena e manda a **p21** travar essa CDK4/6. Resultado? A Rb continua segurando o E2F e o ciclo para.

A Uninove adora cobrar o papel do **HPV** (Proteínas E6 e E7). Saiba também que o **Palbociclibe** é a droga da moda para câncer de mama porque ele imita o p21 e trava a CDK4/6 artificialmente. E no diagnóstico do **Retinoblastoma**, lembre-se da pupila branca na criança (Leucocória) — sinal de que o freio Rb foi perdido nos dois alelos e o tumor cresceu na retina.

### Diferenciações que a Uninove adora cobrar

| Conceito A | Conceito B | Diferencial Crítico |
|------------|------------|-----------------|
| **p53** | **Rb** | Responde a dano no DNA vs **Controla o ponto de restrição G1/S** |
...
> "p53 vigia o DNA e chama o p21; a Rb segura o E2F para não deixar entrar nenhum; se o HPV chegar, a proteção vai pro ralo comum."
