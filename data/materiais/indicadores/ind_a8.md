...
- **Momento:** Seção de siglas dos sistemas.
- **O que mostrar:** Um "Guia Rápido" com os nomes dos sistemas e ícones representando sua função (Caveira/SIM, Bebê/SINASC, Megafone/SINAN, Hospital/SIH).
- **Tipo sugerido:** Infográfico didático.
- **Legenda (rascunho):** Os principais sistemas de informação que sustentam o SUS.

## 1. Os "Três Grandes" da Vigilância

Estes são os mais cobrados em provas de Residência e da Uninove:
...
## 2. Sistemas Hospitalares e Ambulatoriais
...
## 3. O Problema dos Dados (Subnotificação)
...
No seu consultório, você atende um paciente com febre e manchas no corpo. Você suspeita de Dengue. Ao preencher a ficha do **SINAN**, você está alimentando o sistema que vai dizer à prefeitura que tem Dengue naquele bairro. Se você não preencher ("ah, dá muito trabalho"), o carro do fumacê nunca passará naquela rua porque, para o sistema, "não tem Dengue lá". O registro clínico é um ato de saúde pública.

---

## Pontos-Chave para Prova

- **SIM**: Mortes (**Causa Básica**).
- **SINAN**: Doenças de Notificação Compulsória (Aviso obrigatório).
- **SINASC**: Nascimentos (Bebês).
- **SIH**: Internações (**AIH**).
- **Subnotificação**: É o maior inimigo da epidemiologia brasileira.
- **Declaração de Óbito**: É responsabilidade do **Médico** preencher corretamente.
...
Para gabaritar Sistemas de Informação, foque nas siglas. 
**SIM** = Morte. **SINASC** = Nascimento. **SINAN** = Notificação (Dengue/TB). **SIH** = Hospital (Internação). A Uninove adora perguntar qual sistema usar para planejar vacinação (SINASC, para saber quantos bebês nasceram) ou qual usar para ver surto de meningite (SINAN).

Lembre-se: o sistema só é bom se o médico preencher direito. Se a questão falar de "Causas Mal Definidas", ela está criticando o **SIM**. Se falar de "Baixo peso ao nascer", ela está usando dados do **SINASC**. O **e-SUS** é o queridinho atual, pois integra tudo o que acontece no Postinho (APS).
...
> "SIM pra quem partiu, SINASC pra quem chegou, SINAN pra avisar o surto que a dengue provocou."
