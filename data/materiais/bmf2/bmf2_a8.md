# BMF2 — Aula 8: Inervação e Regulação da Pressão Arterial
...
## Inervação Autonômica: O Acelerador e o Freio
...
| Propriedade | Efeito Simpático (Beta-1) | Efeito Parassimpático (M2) |
|-------------|----------------------------|----------------------------|
...
## A Equação de Ouro e a Regulação da PA
...
**Caso Clínico:** Um paciente em uso de um potente vasodilatador apresenta palpitações frequentes (taquicardia).

**Análise Integrada:**
Estamos diante de um **Mecanismo Compensatório**. Quando o medicamento reduz a Resistência Vascular Periférica (RVP), a PA tende a cair. Os **barorreceptores** detectam essa queda de estiramento e enviam sinais ao bulbo, que retira o "freio" vagal e dispara o simpático. O resultado é a taquicardia reflexa, uma tentativa do corpo de manter o Débito Cardíaco e, consequentemente, a pressão arterial estável.

---

## Pontos-Chave para Prova

*   **Barorreflexo:** É o controlador de curto prazo (detecta pressão no seio carotídeo/arco aórtico).
*   **SRAA:** É o controlador de longo prazo (rim detecta baixa perfusão e retém volume).
*   **Beta-1:** Receptor cardíaco simpático principal (alvo de beta-bloqueadores).
*   **Nervo Vago:** Principal via do parassimpático cardíaco (reduz FC).
*   **RVP:** Determinada principalmente pelo calibre das arteríolas.
...
Na prova, divida o controle da PA em "tempo real" e "manutenção". O tempo real é o **Sistema Nervoso**: se a pressão cai (ex: levantar rápido), os barorreceptores avisam o cérebro para disparar o simpático e fechar as torneiras (vasoconstrição) e acelerar o motor (taquicardia). A manutenção é o **Rim**: se ele sente que o fluxo está baixo, libera **Renina**, que ativa a Angiotensina (vasoconstritor potente) e a Aldosterona (que puxa sal e água).

Lembre-se das terminologias técnicas: **Cronotropismo** (Frequência), **Inotropismo** (Força) e **Dromotropismo** (Condução). O vago só atua no "freio" e na "condução", tendo pouco efeito na força dos ventrículos. Já o simpático é total: acelera, fortalece e agiliza tudo.
...
> "Pressão cai: simpático e SRAA sobem; pressão sobe: vago e freio reflexo entram em cena."
