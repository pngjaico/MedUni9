...
- **Quimiorreceptores centrais** (bulbo): CO₂/H⁺ no LCR — não respondem ao O₂
- **Quimiorreceptores periféricos** (corpos carotídeos + aórticos): respondem a ↓PaO₂ (< 60 mmHg), ↑PaCO₂, ↓pH
- **Anemia e CO**: PaO₂ normal → quimiorreceptores periféricos NÃO disparam
- **DPOC retentor**: adaptação ao CO₂ crônico → drive hipóxico → O₂ excessivo suprime ventilação
- **Meta SpO₂ DPOC retentor**: 88–92% (não 100%)
- **Centro pneumotáxico (ponte)**: termina inspiração, controla frequência
- **Hering-Breuer**: distensão pulmonar → inibe inspiração via vago
- **Exercício leve**: ventilação compensa CO₂; **Exercício intenso**: acidose láctica → hiperventilação
- **Pré-Bötzinger**: marca-passo central da respiração automática
