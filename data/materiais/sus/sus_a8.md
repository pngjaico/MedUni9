# SUS — Aula 8: PNAB e Estratégia Saúde da Família (ESF)
...
- **PNAB** normatiza a APS; **ESF** é estratégia de equipe.
- **Primeiro contato** e **longitudinalidade** são pilares.
- **Territorialização:** adscrição de população.
- **NASF:** apoio matricial (reforço) — não confundir com substituição da APS.
