...
Dor pulsátil, febre, massa dolorosa. **Drenagem cirúrgica** é prioridade; antibiótico se **celulite** ou sistêmico — não substitui o dreno. **Fístula** subsequente em parcela significativa — avaliar após resolução aguda.

---

## Fístula perianal — classificação de Park
...
**Figura-ID:** `CIR6-A10-F02`

- **Momento:** após classificação de fístulas.
- **O que mostrar:** esquema **Park** com trajetos em relação ao esfincter.
- **Tipo sugerido:** diagrama coronal ou axial esquemático.
- **Legenda (rascunho):** Fístula perianal: tipos de Park (esquema).
...
**Figura-ID:** `CIR6-A10-F03`

- **Momento:** após abscesso — drenagem.
- **O que mostrar:** foto intraoperatória didática de **drenagem de abscesso perianal** ou esquema de incisão.
- **Tipo sugerido:** ilustração cirúrgica ou foto clínica anônima.
- **Legenda (rascunho):** Abscesso perianal: princípio de drenagem ampla.

---

## Ponte com a Clínica

Paciente com **múltiplas fístulas** e **perda de peso**: pense **Crohn** — colonoscopia, marcadores inflamatórios, manejo médico antes de “cortar tudo”. Paciente imunossuprimido: cobertura antimicrobiana ampla e imagem se profundo.

---

## Pontos-Chave para Prova

- Hemorroida: grau guia tratamento; idoso sangrando: colonoscopia.
- Fissura: esfincter hipertônico — relaxantes antes de cirurgia.
- Abscesso: drenagem; antibiótico não substitui.
- Fístula: Park; RM se complexa; Crohn muda o plano.
...
|------------|------------|------------------|
| Fissura | CA anal | Biópsia se cicatrização falha ou aspecto atípico |
| Hemorroida | neoplasia | Idade, colonoscopia |
| Abscesso | celulite isolada | Flutuação, imagem |
| Fístula simples | complexa | RM, Crohn, recidivas |
