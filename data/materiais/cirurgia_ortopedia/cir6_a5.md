...
Início precoce de **via oral** quando tolerado. Se íleo prolongado, **nutrição enteral** (preferível a parenteral prolongada — conceito de barreira intestinal).
...
- Lipase > amilase em especificidade (referência geral).
- Imagem para necrose/complicações — não todo caso leve precisa TC cedo.
- Antibiótico não profilático rotineiro na necrose estéril (entenda a nuance).
- Hipertrigliceridemia massiva: além do tratamento da pancreatite, abordar causa.
...
|------------|------------|------------------|
| Pancreatite | perfuração péptica | Lipase, TC, ar livre |
| Biliar | alcoólica | USG biliar, história |
| Necrose infectada | estéril | Gas na coleção, cultura, PCT |
| Edematosa | necrotizante | TC com contraste |
