...
|-------------|-------|-------------|
| Diverticulite | Dor FIE, leucocitose, TC inflamatória | TC abdome |
| Apendicite (retrocecal) | Padrão atípico | TC, USG |
...
Dor **em baixo ventre esquerdo** (classicamente), febre, alteração do hábito intestinal. Idosos e imunossuprimidos podem ter apresentação atenuada — **alta suspeita** com leucocitose ou lactato.

---

## Diagnóstico por imagem

**TC abdome** com contraste define gravidade (espessamento, estrato de gordura, abscesso, ar livre). **Classificação de Hinchey** relaciona-se a perfuração e plano cirúrgico (I–IV).
...
**Figura-ID:** `CIR6-A11-F02`

- **Momento:** após complicações — perfuração.
- **O que mostrar:** diagrama **Hinchey I–IV** (localização da perfuração e contaminação).
- **Tipo sugerido:** ilustração esquemática.
- **Legenda (rascunho):** Classificação de Hinchey: perfuração diverticular.

---

## Fístula e pneumaturia

Comunicação **colo-vésica** → **pneumaturia** e infecções urinárias de repetição. Manejo: controle de foco séptico, eventual cirurgia eletiva após otimização.
...
Paciente jovem com dor direita e TC de “diverticulite” direita — considere **mimetizadores** e **apendicite**. Paciente em **imunossupressão**: menor resposta inflamatória, maior risco de evolução grave — limiar baixo para imagem e internação.

---

## Pontos-Chave para Prova

- TC é padrão para gravidade e complicações.
- Hinchey guia perfuração e cirurgia de emergência.
- Colonoscopia: não na fase aguda típica.
- Abscesso: drenagem quando indicado; antibiótico sozinho pode falhar.
...
|------------|------------|------------------|
| Diverticulite | IBD | TC, história, colonoscopia tardia |
| Abscesso | flegmão simples | Coleção com borda em TC |
| Hinchey I | IV | Extensão da contaminação peritoneal |
