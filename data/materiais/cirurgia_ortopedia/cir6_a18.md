...
|------|----------------|-------|
| I | Ferimento <1 cm, limpo | Lavagem, fixação conforme fratura |
...
- Fratura aberta: antibiótico + desbridamento; Gustilo guia prognóstico.
- Luxação: redução + imagem pós + neurovascular.
- Imobilização: cuidado com edema e compartimento.
- Consolidação: pseudoartrose — causas multifatoriais.
...
|------------|------------|------------------|
| Luxação | subluxação | Perda completa vs parcial |
| Fratura fechada | aberta | Pele (qualquer comunicação) |
| Tala | gesso completo | Edema, compartimento |
