...
## Fisiopatologia resumida (mapa mental)
...
- **Urina escura** (bilirrubina direta), **fezes acólicas** (obstrução completa).  
- **Prurido** intenso (colestase).  
- **Perda de peso** e dor insidiosa (malignidade).  
- **Dor em cólica** (cálculo) vs dor constante (pancreatite).  
- **Medicamentos** e álcool (hepatite tóxica).

### Figura sugerida

**Figura-ID:** `CIR6-A4-F01`

- **Momento:** após mapa fisiopatológico (anatomia das vias biliares).
- **O que mostrar:** diagrama com **ductos biliares**, vesícula e relação com duodeno/pâncreas.
- **Tipo sugerido:** SVG ou ilustração didática.
- **Legenda (rascunho):** Árvore biliar e relação com pâncreas/duodeno.
...
**Figura-ID:** `CIR6-A4-F02`

- **Momento:** após exame físico (detecção de icterícia).
- **O que mostrar:** fotografia clínica de **icterícia escleral** evidente.
- **Tipo sugerido:** imagem clínica (autorização/ética conforme fonte).
- **Legenda (rascunho):** Icterícia: coloração amarelada da esclerótica.
...
Paciente com **febre + hipotensão + icterícia** não é “virose” — é **emergência biliar** até prova contrária. Anote horário do primeiro antibiótico e da CPRE em auditoria clínica.

---

## Pontos-Chave para Prova

- Colestase: prurido, urina escura, fezes claras (padrão clássico).
- Colangite grave = CPRE + ATB + suporte (critérios de gravidade).
- Courvoisier: vesícula palpável indolor + icterícia → investigar malignidade.
- **CA 19-9** auxilia seguimento/risco, **não** diagnostica sozinho.
...
|------------|------------|------------------|
| Cálculo | tumor | Imagem, idade, evolução |
| Hepatite | obstrução | FA/GGT, ductos ao USG |
| Hemólise | colestase | LDH, morfologia eritrocitária |
| Síndrome de Mirizzi | colecistite simples | Anatomia, compressão do ducto |
