...
- **Valva mitral**: 2 cúspides (bicúspide); **Tricúspide**: 3 cúspides; **ambas com cordas tendíneas**
- **Valvas semilunares** (aórtica e pulmonar): 3 cúspides; SEM cordas tendíneas
- **Artérias pulmonares**: sangue venoso (desoxigenado) — nomenclatura pelo sentido do fluxo
- **Músculo cardíaco**: ramificado, núcleo central, discos intercalares
- **Fibras de Purkinje**: grandes, pálidas, glicogênio, subendocárdicas — condução rápida
- **Camadas**: endocárdio → miocárdio → epicárdio (= pericárdio visceral)
- **Artéria elástica (aorta)**: muitas lamelas elásticas na média
- **Artéria muscular**: músculo liso na média + lâminas elásticas interna e externa bem definidas
- **Fossa oval**: septo interatrial, AD (cicatriz do forame oval)
