...
- **Epitélio respiratório**: pseudoestratificado colunar ciliado + células caliciformes (mucosas)
- **Cartilagem**: traqueia = anéis em "C"; brônquios = placas; bronquíolos = AUSENTE
- **Células caliciformes**: desaparecem nos bronquíolos (substituídas por células de Clara)
- **Pneumócito tipo I**: escamoso, 95% da área, difusão gasosa
- **Pneumócito tipo II**: cúbico, corpos lamelares, surfactante (DPPC), célula-tronco alveolar
- **Macrófago alveolar**: fagocitose; com partículas de carbono = antracose (tabagista)
- **Membrana alvéolo-capilar**: ~0,5 µm; espessamento → hipoxemia
- **Índice de Reid > 0,5**: bronquite crônica (glândulas submucosas hipertrofiadas)
- **Mesotelioma**: tumor do mesotélio pleural; causado por asbesto/amianto
