...
- **Prática real:** amplia complexidade do raciocínio clínico.
- **Método semiológico:** deve ser mantido sob variabilidade.
- **Supervisão docente:** componente de segurança.
- **Consentimento:** obrigatório antes do exame.
- **Prontuário:** precisa ser claro e objetivo.
- **Reconhecer limite:** demonstra maturidade clínica.
- **Conduta inicial:** deve ser segura e justificável.
- **Dados reais:** valem mais que hipótese bonita.
