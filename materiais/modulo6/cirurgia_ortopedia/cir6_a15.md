...
Ativa e passiva — **perda de ADM passiva** sugere **contratura** articular ou bloqueio (corpo livre). **Hipermobilidade** pode mascarar instabilidade.

### Figura sugerida

**Figura-ID:** `CIR6-A15-F01`

- **Momento:** após exame físico — referências pediátricas.
- **O que mostrar:** ilustração de **linhas de Bryant e Galeazzi** no antebraço (trauma pediátrico).
...
**Figura-ID:** `CIR6-A15-F02`

- **Momento:** após joelho — instabilidade.
...
|------------|------------|------------------|
| Lesão meniscal | LCA | História, testes, RM |
| Epicondilite lateral | cervical | Palpação, provas nervosas |
| Fratura | contusão | Imagem se dúvida |
