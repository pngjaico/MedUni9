...
|--------|----------------|--------------|--------|
| **HAV** | Fecal-oral | Não (curso agudo) | Sim |
| **HBV** | Parenteral, sexual, vertical | Sim | Sim |
| **HCV** | Parenteral (sangue); sexual menos eficiente | Sim | Não (universal) |
| **HDV** | Só com **HBV** ativo | Sim (depende do HBV) | Indireta (HBV) |
...
### Por que o painel sorológico é peça-chave de prova

O HBV replica no fígado; a interpretação integra **antígenos de superfície e core**, **anticorpos**, **marcadores de replicação** e **DNA viral**.

### Mapa dos principais marcadores

| Marcador | Significado clínico (simplificado) |
|----------|-------------------------------------|
| **HBsAg** | **Superfície** — infecção ativa (aguda ou crônica conforme duração >6 meses) |
| **Anti-HBs** | **Imunidade** — vacina bem-sucedida ou recuperação com eliminação do vírus |
| **Anti-HBc IgM** | **Core IgM** — infecção aguda recente (janela útil) |
| **Anti-HBc total** | Exposição prévia ao vírus (aguda passada, crônica ou resolvida — interpretar com os demais) |
| **HBeAg / anti-HBe** | Marcadores associados à **replicação** (com limitações; não substituem DNA) |
| **HBV-DNA (quantitativo)** | **Replicação viral**; guia decisão terapêutica em crônicos |

### Padrões que a banca adora

- **Vacina:** em geral **anti-HBs reagente**, **HBsAg negativo**, **anti-HBc negativo**.  
- **Recuperação natural:** **anti-HBs** e **anti-HBc** positivos, **HBsAg negativo**.  
- **Cronificação:** **HBsAg** persistente além do período de definição de cronicidade (conceito temporal fundamental).

### Tratamento (princípios)

Analogues de nucleos(t)ídeos e outras estratégias são indicados conforme **replicação**, **fibrose**, **ALT** e comorbidades — seguir diretrizes; o material de graduação foca em **quem precisa de terapia supressiva** versus vigilância.

### Prevenção

**Vacina** recombinante (HBsAg) no calendário infantil e catch-up em adultos conforme normas. **Profilaxia pós-exposição** (vacina ± imunoglobulina) em acidentes e exposição perinatal segue protocolo.

> **Pegadinha:** **anti-HBc isolado** (positivo) com anti-HBs e HBsAg negativos pode ser **resolução remota**, **falso positivo**, **janela** ou **crônico de baixa replicação** — depende de **DNA**, história e vacinação; não conclua com um único exame.

### Natural history e momentos decisivos (HBV)
...
- **Coinfecção:** HBV e HDV **juntos** no início — curso pode variar.  
- **Superinfecção:** HDV em portador **crônico de HBV** — associação com **pior prognóstico** e maior risco de descompensação.
...
- **HAV:** IgM agudo; IgG imunidade; vacina; sem cronificação clássica.  
- **HBV:** dominar **HBsAg**, **anti-HBs**, **anti-HBc**, **DNA**; cronificação por tempo e HBsAg persistente.  
- **HCV:** **RNA** define atividade; **DAAs** para cura na maioria.  
- **HDV** só com **HBV**; superinfecção **grave**.  
- **HEV:** surtos hídricos; **gravidez** pode ser complicada; imunossuprimidos — risco diferente.  
- Complicações tardias de **B e C:** fibrose, cirrose, **HCC** — vigilância.
...
|------------|------------|------------------|
| Anti-HCV reagente | Infecção ativa | **HCV-RNA** |
| HBsAg positivo (crônico) | Imunidade vacinal | Vacina: tipicamente HBsAg−, anti-HBs+, anti-HBc− |
| Coinfecção HBV/HDV | Superinfecção HDV | Momento da infecção por HDV em relação ao portador HBV |
| HAV IgM | HAV IgG | IgM = agudo; IgG = imunidade prévia/pós |

### Frase-âncora para não esquecer

> “Hepatite viral começa com **qual letra** (A–E) e termina com **qual marcador** (IgM, HBsAg, RNA) — sem isso, não há conduta segura.”
