# SEMIO1 - Aula 3: Exame Físico — Inspeção
...
Exame Físico — Inspeção é conteúdo de alto impacto porque conecta base teórica, interpretação clínica e tomada de decisão. Na prática, ele aparece em discussão de caso, prova objetiva e atendimento supervisionado.
...
Paciente de meia-idade chega com quadro compatível com Exame Físico — Inspeção, início recente e impacto funcional progressivo. O objetivo inicial é localizar o problema antes de fechar etiologia.
...
Na prática clínica, Exame Físico — Inspeção aparece em cenários com decisão sob tempo curto.
...
Quando a lógica de Exame Físico — Inspeção fica clara, o estudante deixa de decorar e passa a interpretar.
...
Os professores costumam cobrar Exame Físico — Inspeção com enunciado enxuto e pegadinhas de contexto.
...
A integração de conceito, dado objetivo e conduta é o centro do domínio de Exame Físico — Inspeção.
Quando duas hipóteses competem, um critério objetivo costuma definir a direção correta.

> **Dica de Prova:** Em questões de Exame Físico — Inspeção, procure o dado que muda conduta; esse detalhe costuma decidir a alternativa correta.

### Núcleo de aprofundamento 5: Aplicação semiológica
Em Semiologia do Sistema Musculoesquelético, o valor de Exame Físico — Inspeção está em transformar teoria em escolha clínica segura.
...
Na prática real, Exame Físico — Inspeção aparece com comorbidades, informação incompleta e necessidade de priorização.
