...
- **Momento:** Seção de infecções agudas.
- **O que mostrar:** O "Termômetro da Pele": Um esquema comparando a **Erisipela** (superficial, borda nítida, "em degrau") com a **Celulite** (profunda, borda borrada, difusa) e o **Abscesso** (com ponto de pus). Mostrar também o teste de sensibilidade na hanseníase.
- **Tipo sugerido:** Infográfico didático | Esquema anatômico.
- **Legenda (rascunho):** Diferenças clínicas entre as principais infecções da pele e dos nervos.
...
## 2. Abscessos e Furúnculos

Quando a infecção "se fecha" em uma bolsa de pus, temos um abscesso.
- **O que procurar:** O sinal da **Flutuação** (você aperta e sente um líquido se mexendo lá dentro).
- **Tratamento:** Antibiótico sozinho não entra dentro da bolsa de pus. Por isso, a regra de ouro é: **"Ubi pus, ibi evacua"** (Onde há pus, deve ser drenado).

---

## 3. Hanseníase: A Doença que "Rouba" o Nervo
...
No pronto-atendimento, nunca ignore uma "micose" que não coça e não dói. Se você testar a sensibilidade térmica (usando um algodão com álcool gelado e um algodão seco) e o paciente não souber a diferença, você acabou de fazer o diagnóstico de **Hanseníase**. Tratar a ferida da erisipela salva a perna do paciente hoje; diagnosticar a hanseníase salva a função das mãos dele para o resto da vida.

---

## Pontos-Chave para Prova

- **Erisipela**: Borda nítida, superficial, "sinal do degrau".
- **Celulite**: Borda imprecisa, profunda, estende-se mais facilmente.
- **Flutuação**: Indica necessidade de **Drenagem** do abscesso.
- **Hipoestesia**: Perda de sensibilidade em manchas de pele (Hanseníase).
- **Nervo Espessado**: Sinal clássico de dano neural pela hanseníase.
...
Para gabaritar Infecções de Pele, separe o agudo do crônico. 
Se a perna está vermelha, quente e o paciente tem febre hoje, é **Erisipela ou Celulite**. Se a mancha está lá faz meses e o paciente não sente o toque, é **Hanseníase**. Na erisipela, a borda é nítida. Na celulite, a borda "some" na pele normal. Se você apertar e o pus "dançar" (flutuação), a conduta é **Drenar**.

A Uninove ama cobrar sobre a sensibilidade da Hanseníase. Lembre-se que a sequência da perda é: **Térmica** (primeiro), depois **Dolorosa** e por fim a **Tátil**. Se o paciente sente o toque mas não sente o gelado, já é hanseníase! No tratamento da erisipela/celulite, lembre-se de olhar entre os dedos (frieira) pois é a principal porta de entrada das bactérias. Por fim, saiba que hanseníase não é contagiosa após o início do tratamento.
...
> "Erisipela desenha, celulite borra, e o abscesso pede o bisturi. Na hanseníase, a mancha não dói, mas o nervo chora; se o paciente não sente o gelado, o bacilo já está morando lá dentro."
