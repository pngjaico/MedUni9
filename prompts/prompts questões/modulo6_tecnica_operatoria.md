# Refatorar questões — Técnica Operatória (`tecnica_operatoria`)

**Módulo:** 6 · **Sigla:** TO · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/tecnica_operatoria/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo6/tecnica_operatoria/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `tecnica_operatoria`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  tcar_a1, tcar_a2, tcar_a3, tcar_a4, tcar_a5, tcar_a6, tcar_a7, tcar_a8, tcar_a9, tcar_a10
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "tecnica_operatoria"` e `"tema": "<aula_id>"`.
