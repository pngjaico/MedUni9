# Refatorar questões — Medicina de Família e Comunidade (`mfc6`)

**Módulo:** 6 · **Sigla:** MFC · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/mfc6/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo6/mfc6/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `mfc6`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  mfc_a1, mfc_a2, mfc_a3, mfc_a4, mfc_a5, mfc_a6
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "mfc6"` e `"tema": "<aula_id>"`.
