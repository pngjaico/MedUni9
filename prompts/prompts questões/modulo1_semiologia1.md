# Refatorar questões — Semiologia do Sistema Musculoesquelético (`semiologia1`)

**Módulo:** 1 · **Sigla:** SEMIO1 · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/semiologia1/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo1/semiologia1/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `semiologia1`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  semio1_a1, semio1_a2, semio1_a3, semio1_a4, semio1_a5, semio1_a6, semio1_a7, semio1_a8, semio1_a9
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "semiologia1"` e `"tema": "<aula_id>"`.
