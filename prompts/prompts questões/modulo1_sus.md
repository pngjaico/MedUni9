# Refatorar questões — Princípios e Diretrizes do SUS (`sus`)

**Módulo:** 1 · **Sigla:** SUS · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/sus/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo1/sus/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `sus`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  sus_a1, sus_a2, sus_a3, sus_a4, sus_a5, sus_a6, sus_a7, sus_a8, sus_a9
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "sus"` e `"tema": "<aula_id>"`.
