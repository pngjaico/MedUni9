# Refatorar questões — Farmacologia Aplicada (`farmaco_aplicada`)

**Módulo:** 5 · **Sigla:** FARM · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/farmaco_aplicada/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo5/farmaco_aplicada/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `farmaco_aplicada`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  farm_a1, farm_a2, farm_a3, farm_a4, farm_a5, farm_a6, farm_a7, farm_a8, farm_a9, farm_a10, farm_a11, farm_a12
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "farmaco_aplicada"` e `"tema": "<aula_id>"`.
