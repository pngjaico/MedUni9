# Refatorar questões — Processos Fisiopatológicos e Farmacoterapêuticos Neuroendócrinos (`fisiopato_farmaco`)

**Módulo:** 4 · **Sigla:** FF4 · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/fisiopato_farmaco/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo4/fisiopato_farmaco/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `fisiopato_farmaco`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  ff4_a1, ff4_a2, ff4_a3, ff4_a4, ff4_a5, ff4_a6, ff4_a7, ff4_a8, ff4_a9, ff4_a10, ff4_a11, ff4_a12, ff4_a13, ff4_a14
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "fisiopato_farmaco"` e `"tema": "<aula_id>"`.
