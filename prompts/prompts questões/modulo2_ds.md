# Refatorar questões — Dimensões Socioambientais e Saúde (`ds`)

**Módulo:** 2 · **Sigla:** DS · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/ds/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo2/ds/<aula_id>.md`
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "ds"` e `"tema": "<aula_id>"`.
