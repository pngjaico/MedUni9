# Refatorar questões — Cirurgia e Ortopedia 6 (`cirurgia_ortopedia`)

**Módulo:** 6 · **Sigla:** CIR6 · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/cirurgia_ortopedia/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo6/cirurgia_ortopedia/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `cirurgia_ortopedia`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  cir6_a1, cir6_a2, cir6_a3, cir6_a4, cir6_a5, cir6_a6, cir6_a7, cir6_a8, cir6_a9, cir6_a10, cir6_a11, cir6_a12, cir6_a13, cir6_a14, cir6_a15, cir6_a16, cir6_a17, cir6_a18, cir6_a19, cir6_a20, cir6_a21
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "cirurgia_ortopedia"` e `"tema": "<aula_id>"`.
