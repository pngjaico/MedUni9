# Refatorar questões — Processos Metabólicos Humanos (`pmh`)

**Módulo:** 1 · **Sigla:** PMH · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/pmh/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo1/pmh/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `pmh`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  pmh_a1, pmh_a2, pmh_a3, pmh_a4, pmh_a5, pmh_a6, pmh_a7, pmh_a8, pmh_a9, pmh_a10, pmh_a11, pmh_a12, pmh_a13, pmh_a14
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "pmh"` e `"tema": "<aula_id>"`.
