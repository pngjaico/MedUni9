# Refatorar questões — Bases Morfofuncionais 3 — Digestório, Renal e Reprodutor (`bmf3`)

**Módulo:** 3 · **Sigla:** BMF3 · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/bmf3/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo3/bmf3/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `bmf3`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  bmf3_a1, bmf3_a2, bmf3_a3, bmf3_a4, bmf3_a5, bmf3_a6, bmf3_a7, bmf3_a8, bmf3_a9, bmf3_a10, bmf3_a11, bmf3_a12, bmf3_a13, bmf3_a14, bmf3_a15, bmf3_a16, bmf3_a17, bmf3_a18, bmf3_a19, bmf3_a20, bmf3_a21, bmf3_a22
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "bmf3"` e `"tema": "<aula_id>"`.
