# Refatorar questões — Saúde do Trabalhador e Doenças Ocupacionais (`saude_trabalhador`)

**Módulo:** 3 · **Sigla:** ST · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/saude_trabalhador/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo3/saude_trabalhador/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `saude_trabalhador`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  st_a1, st_a2, st_a3, st_a4, st_a5, st_a6, st_a7, st_a8
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "saude_trabalhador"` e `"tema": "<aula_id>"`.
