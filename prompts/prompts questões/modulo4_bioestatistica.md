# Refatorar questões — Bioestatística e Estudos em Saúde (`bioestatistica`)

**Módulo:** 4 · **Sigla:** BIOE · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/bioestatistica/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo4/bioestatistica/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `bioestatistica`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  bioe_a1, bioe_a2, bioe_a3, bioe_a4, bioe_a5, bioe_a6, bioe_a7, bioe_a8, bioe_a9, bioe_a10, bioe_a11, bioe_a12
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "bioestatistica"` e `"tema": "<aula_id>"`.
