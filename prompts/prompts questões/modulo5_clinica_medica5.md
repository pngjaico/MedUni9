# Refatorar questões — Clínica Médica 5 (`clinica_medica5`)

**Módulo:** 5 · **Sigla:** CM5 · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/clinica_medica5/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo5/clinica_medica5/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `clinica_medica5`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  cm5_a1, cm5_a2, cm5_a3, cm5_a4, cm5_a5, cm5_a6, cm5_a7, cm5_a8, cm5_a9, cm5_a10, cm5_a11, cm5_a12, cm5_a13, cm5_a14, cm5_a15, cm5_a16, cm5_a17, cm5_a18, cm5_a19, cm5_a20, cm5_a21
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "clinica_medica5"` e `"tema": "<aula_id>"`.
