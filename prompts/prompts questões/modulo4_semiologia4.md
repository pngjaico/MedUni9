# Refatorar questões — Semiologia Neurológica e Síndromes Clínicas (`semiologia4`)

**Módulo:** 4 · **Sigla:** SEMIO4 · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/semiologia4/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo4/semiologia4/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `semiologia4`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  semio4_a1, semio4_a2, semio4_a3, semio4_a4, semio4_a5, semio4_a6, semio4_a7, semio4_a8, semio4_a9, semio4_a10
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "semiologia4"` e `"tema": "<aula_id>"`.
