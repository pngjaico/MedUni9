# Refatorar questões — Mecanismos de Agressão e Defesa (`mad1`)

**Módulo:** 2 · **Sigla:** MAD1 · **Ficheiro de saída:** `data/questoes.json`
...
3. Para cada aula, **antes** de reescrever as 10 questões, leia o Markdown em:
   - `data/materiais/mad1/<aula_id>.md`
   - se faltar, espelho: `materiais/modulo2/mad1/<aula_id>.md`

## Escopo desta disciplina

- `materia` (JSON): `mad1`
- Aulas (ordem do catálogo — cada `aula_id` tem **10** questões):  
  mad1_a1, mad1_a2, mad1_a3, mad1_a4, mad1_a5, mad1_a6, mad1_a7, mad1_a8, mad1_a9, mad1_a10, mad1_a11, mad1_a12, mad1_a13, mad1_a14, mad1_a15, mad1_a16, mad1_a17, mad1_a18, mad1_a19, mad1_a20, mad1_a21, mad1_a22, mad1_a23, mad1_a24
...
1. Ler o `.md` da aula.
2. Isolar em `data/questoes.json` as **10** entradas com `"materia": "mad1"` e `"tema": "<aula_id>"`.
